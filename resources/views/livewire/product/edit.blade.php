    ...
    <form wire:submit.prevent="submit" class='grid gap-4 grid-cols-1 md:grid-cols-2 w-auto mx-5 md:mx-0 md:w-auto'>
        <div>            
            ...
            <div class="col-span-1">
                ...
                <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" wire:model.debounce.300ms="product.name" placeholder="">
                <x-jet-input-error for="name" class="mt-2" />
            </div>

            <div class="col-span-1 mt-5">
                <label for="price">Price</label>
                <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" wire:model.debounce.300ms="product.price" placeholder="">
                <x-jet-input-error for="price" class="mt-2" />
            </div>

            <div class="col-span-1 mt-5">
                <label for="quantity">Quantity</label>
                <input class="form-input rounded-md shadow-sm mt-1 block w-full" type="text" wire:model.debounce.300ms="product.quantity" placeholder="">
